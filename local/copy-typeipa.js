...
const characters = keyblocks
  .map((keyblock) =>
    Array.from(keyblock.querySelectorAll("button"))
      .map((button) => ({
...
const metadata = {
  ...
  howto:
    "I copied the relevant HTML manuarlly because it is generated with JS on the site. Thensaved to typeit.org-ipa.html",
}
